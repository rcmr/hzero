...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_location.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_location") {
        ...
        createTable(tableName: "hpfm_location", remarks: "货位") {
            column(name: "location_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "inventory_id", type: "bigint(20)",  remarks: "库房ID,hpfm_inventory.inventory_id")  {constraints(nullable:"false")}  
